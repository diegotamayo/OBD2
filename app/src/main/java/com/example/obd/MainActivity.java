...
public class MainActivity extends Activity {
    ...
    private ObdCommand command1 = new SpeedCommand();
    private ObdCommand command2 = new RPMCommand();
    ...
    private int chosenParametersAmount = 5;
    ...
    private void continueBluetooth(){
        ...
        if (pairedDevices.size() > 0) {
            ...
            mBuilder.setSingleChoiceItems(devicesString, -1, (dialog, i) -> {
                ...
                Toast.makeText(MainActivity.this, "M4 Chosen: " + chosenDeviceName, Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(this, "M5 No paired devices found", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void connectOBD() {
        try {
            ...
            Toast.makeText(MainActivity.this, "M6 Connected to OBD", Toast.LENGTH_SHORT).show();
            bStart.setEnabled(true);
            bConnect.setEnabled(false);

        } catch (IllegalArgumentException e) {
            Toast.makeText(MainActivity.this, "M7 Please choose Bluetooth device first", Toast.LENGTH_LONG).show();
        } catch (IOException e) {
            Toast.makeText(MainActivity.this, "M8 Unable to establish connection", Toast.LENGTH_LONG).show();
        } catch (Exception e){
